...
function loadSpinnerElem()
{
    ...
    <i class="fa fa-spinner fa-spin fa-5x text-white  loadingIcon"></i>
  </div>`;
}
...
function createAreaCardElem(name)
{
    ...
    <div class="col-lg-3 col-md-6">
        <div class="area-card">
        <div class="icon fs-1 text-danger"><i class="fas fa-city"></i></div>
            <h2 class="text-center text-white fs-3 mt-3">${name}</h2>
        </div>
    </div>`;
}
